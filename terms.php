				...
				<nav class="navbar navbar-expand-lg navbar-light bg-light">
					...
					<div class="collapse navbar-collapse" id="navbarSupportedContent">
						<ul class="navbar-nav ml-auto text-center mr-xl-5">
										...
										<div class="row">
											<div class="col-sm-6 multi-gd-img">
												<ul class="multi-column-dropdown">
													<li>
														<a href="mobile.html">All Mobile Phones</a>
													</li>
													<li>
														<a href="mobile.html">All Mobile Accessories</a>
													</li>
													<li>
														<a href="mobile.html">Cases & Covers</a>
													</li>
													<li>
														<a href="mobile.html">Screen Protectors</a>
													</li>
													<li>
														<a href="mobile.html">Power Banks</a>
													</li>
													<li>
														<a href="mobile.html">All Certified Refurbished</a>
													</li>
													<li>
														<a href="mobile.html">Tablets</a>
													</li>
													<li>
														<a href="mobile.html">Wearable Devices</a>
													</li>
													<li>
														<a href="mobile.html">Smart Home</a>
													</li>
												</ul>
											</div>
											<div class="col-sm-6 multi-gd-img">
												<ul class="multi-column-dropdown">
													<li>
														<a href="mobile.html">Laptops</a>
													</li>
													<li>
														<a href="mobile.html">Drives & Storage</a>
													</li>
													<li>
														<a href="mobile.html">Printers & Ink</a>
													</li>
													<li>
														<a href="mobile.html">Networking Devices</a>
													</li>
													<li>
														<a href="mobile.html">Computer Accessories</a>
													</li>
													<li>
														<a href="mobile.html">Game Zone</a>
													</li>
													<li>
														<a href="mobile.html">Software</a>
													</li>
												</ul>
											</div>
										</div>
									...
									<div class="agile_inner_drop_nav_info p-4">
										...
										<div class="row">
											<div class="col-sm-6 multi-gd-img">
												<ul class="multi-column-dropdown">
													<li>
														<a href="laptop.html">Televisions</a>
													</li>
													<li>
														<a href="laptop.html">Home Entertainment Systems</a>
													</li>
													<li>
														<a href="laptop.html">Headphones</a>
													</li>
													<li>
														<a href="laptop.html">Speakers</a>
													</li>
													<li>
														<a href="laptop.html">MP3, Media Players & Accessories</a>
													</li>
													<li>
														<a href="laptop.html">Audio & Video Accessories</a>
													</li>
													<li>
														<a href="laptop.html">Cameras</a>
													</li>
													<li>
														<a href="laptop.html">DSLR Cameras</a>
													</li>
													<li>
														<a href="laptop.html">Camera Accessories</a>
													</li>
												</ul>
											</div>
											<div class="col-sm-6 multi-gd-img">
												<ul class="multi-column-dropdown">
													<li>
														<a href="laptop.html">Musical Instruments</a>
													</li>
													<li>
														<a href="laptop.html">Gaming Consoles</a>
													</li>
													<li>
														<a href="laptop.html">All Electronics</a>
													</li>
													<li>
														<a href="laptop.html">Air Conditioners</a>
													</li>
													<li>
														<a href="laptop.html">Refrigerators</a>
													</li>
													<li>
														<a href="laptop.html">Washing Machines</a>
													</li>
													<li>
														<a href="laptop.html">Kitchen & Home Appliances</a>
													</li>
													<li>
														<a href="laptop.html">Heating & Cooling Appliances</a>
													</li>
													<li>
														<a href="laptop.html">All Appliances</a>
													</li>
												</ul>
											</div>
										</div>
							...
							<li class="nav-item mr-lg-2 mb-lg-0 mb-2">
								<a class="nav-link" href="mobile.html">New Arrivals</a>
							</li>
							<li class="nav-item dropdown mr-lg-2 mb-lg-0 mb-2">
								<a class="nav-link dropdown-toggle" href="#" role="button" data-toggle="dropdown"
									aria-haspopup="true" aria-expanded="false">
								...
								<div class="dropdown-menu">
									<a class="dropdown-item" href="mobile.html">Product 1</a>
									<a class="dropdown-item" href="laptop.html">Product 2</a>
					...
					<div class="row footer-info w3-agileits-info">
						...
						<div class="col-md-3 col-sm-6 footer-grids">
							...
							<ul>
								...
								<li class="mb-3">
									<a href="mobile.html">Computers</a>
								</li>
								<li class="mb-3">
									<a href="mobile.html">TV, Audio</a>
								</li>
								<li class="mb-3">
									<a href="laptop.html">Smartphones</a>
								</li>
								<li class="mb-3">
									<a href="mobile.html">Washing Machines</a>
								</li>
								<li>
									<a href="laptop.html">Refrigerators</a>
								</li>
