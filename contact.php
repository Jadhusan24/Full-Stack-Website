...
?>
				...
				<div class="col-sm-4 contact-grid agileinfo-6">
					<div class="contact-grid1 text-center">
						...
						<p>
							...
							<label>
								<a href="mailto:info@example.com">cyberstore@gmail.com</a>
							</label>
						</p>
					</div>
				</div>
	...
	<div class="map mt-sm-0 mt-4">
		<iframe width="500" height="400" id="gmap_canvas"
			src="https://maps.google.com/maps?q=ICBT&t=&z=15&ie=UTF8&iwloc=&output=embed" frameborder="0" scrolling="no"
